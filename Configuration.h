...
#define STRING_CONFIG_H_AUTHOR "(Adam, CR Touch)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender 3 v2
    ...
    #define DEFAULT_Kp_LIST {  26.89,  26.89 }
    #define DEFAULT_Ki_LIST {   2.30,   2.30 }
    #define DEFAULT_Kd_LIST {  78.65,  78.65 }
  #else
    #define DEFAULT_Kp  26.89
    #define DEFAULT_Ki   2.30
    #define DEFAULT_Kd  78.65
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 126.68
  #define DEFAULT_bedKi 24.70
  #define DEFAULT_bedKd 433.08
